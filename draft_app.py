...
def main():
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "Sleeper Rank": st.column_config.NumberColumn("Sleeper Rank", width="small", format="%.0f", help="Sleeper's player ranking (lower is better)"),
            "Age": st.column_config.NumberColumn("Age", width="small", format="%.0f", help="Player's age"),
            "Exp": st.column_config.NumberColumn("Years Experience", width="small", format="%.0f", help="Years of NFL experience"),
